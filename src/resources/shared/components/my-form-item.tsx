...
import { FormControl, FormItem, FormLabel, FormMessage } from '@/resources/shared/ui/form'
import { Input } from '@/resources/shared/ui/input'
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/resources/shared/ui/select'
...
export const MyFormItem = ({ field, label, placeholder, setDeliveryMethod, type = 'text', businessName }: MyFormItemProps) => {
	...
	// Solo cargar categorías si el campo es categoryId
	const shouldLoadCategories = field.name === 'categoryId'
	const { data: categories } = useCategories(shouldLoadCategories)
