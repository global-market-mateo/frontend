...
import { Sheet, SheetClose, SheetContent, SheetTrigger } from '@/resources/shared/ui/sheet'
...
export const TopMenu = ({ businessName }: { businessName: string }) => {
	...
	return (
		<>
			<header className={`sticky top-0 flex justify-center py-2  px-5 md:px-10 bg-background z-50 w-full transition-all duration-300 ${isScrolled ? 'scrolled' : ''}`}>
