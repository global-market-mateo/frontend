...
import { useCreateBusinessProduct, useUpdateBusinessProduct } from "@/actions";
...
const ProductSchema = z.object({
  amount: z
    .string()
    .min(3, "El campo 'amount' debe tener al menos 3 caracteres."),
  brand: z
    .string()
    .min(3, "El campo 'brand' debe tener al menos 3 caracteres."),
  description: z
    .string()
    .min(3, "El campo 'description' debe tener al menos 3 caracteres."),
    ...
    <Form {...form}>
      ...
      >
        ...
        <FormField
          control={form.control}
          name="url"
          render={({ field }) => <MyFormItem field={field} label="Url" />}
        />
        <FormField
          control={form.control}
          name="categoryId"
