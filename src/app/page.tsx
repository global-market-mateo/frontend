"use client";
import { getUser, useBusinesses } from "@/actions";
        ...
        <div className="container relative pb-10">
          <section className="mx-auto flex max-w-[980px] flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-6">
            ...
            <span className="max-w-[750px] text-center text-lg font-light text-foreground">
              Facilita la venta online de tu supermercado con nuestra
              plataforma. Gestiona tus productos, organiza pedidos y atiende a
              tus clientes de manera simple y efectiva. Con nuestra solución,
              podrás empezar a vender en línea de forma rápida y sin
              complicaciones, para hacer crecer tu negocio fácilmente.
            </span>
