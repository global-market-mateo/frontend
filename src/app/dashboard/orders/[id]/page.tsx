"use client";
import { useGetOrderByid, useUpdateOrder } from "@/actions";
import {
  AddProductOrder,
  ContentLayout,
  Dialog,
          ...
          <Card className="mb-8">
            <CardHeader className="flex-row justify-between w-full ">
              ...
              <div className="flex gap-4 items-center  h-full">
                <Badge
                  className={`${order.isApproved ? "bg-green-600" : "bg-red-500"} text-md py-1 px-2`}
                >
                  {order.isApproved ? "Aprobado" : "Pendiente"}
                </Badge>
              </div>
            </CardHeader>
            <CardContent className="flex items-center gap-4 justify-between">
              <p className="text-md text-gray-500 text-muted-foreground">
                ...
                {!order.isApproved && (
                  <Dialog>
                    ...
                    <DialogContent>
                      ...
                      <p>
                        Al confirmar el pedido, el cliente recibirá un correo
                        con la confirmación de su compra.
                      </p>
