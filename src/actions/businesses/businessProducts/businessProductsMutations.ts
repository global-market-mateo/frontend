...
import {
  createBusinessProductsFn,
  deleteBusinessProductsFn,
  updateBusinessProductsFn,
...
export const useCreateBusinessProduct = () => {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      handleMutationSuccess(queryClient, toast, "Producto creado"),
  });
};
...
export const useDeleteBusinessProduct = () => {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      handleMutationSuccess(queryClient, toast, "Producto eliminado"),
  });
};
...
export const useUpdateBusinessProduct = () => {
  ...
  return useMutation({
    ...
    onSuccess: () =>
      handleMutationSuccess(queryClient, toast, "Producto actualizado"),
  });
};
